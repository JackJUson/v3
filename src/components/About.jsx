    ...
    <div name='about' className='w-full h-full bg-[#0a192f] flex justify-evenly items-center'>
      ...
      >
        <p className='lg:w-1/2 m-11 mt-[4rem] lg:m-0'>
          ...
          Hi there! My name is Jackson and I love creating useful web applications that could help
          others and myself.
          <br />
          <br />
          My interest in <span className='text-[#64ffda] text-underline'>web development</span>{' '}
          started with building my own websites such as productivity apps, games and tools during
          the lockdown of 2019.
          <br />
          <br />
          As of today, I have graduated from UNSW within Computer Science and working as a software
          engineer at <span className='text-[#64ffda] text-underline'>Telstra!</span>
          <br />
          <br />
        ...
        <div className='relative group hidden sm:block group mb-[4rem] lg:mb-0'>
          <img src={Profile} alt='Profile Image' className='relative w-[300px] z-20 rounded-md' />
          <div
